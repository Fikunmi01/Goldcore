...
export const Services = () => {
    ...
    return (
        <div>
            <div className="p-16 bg-[#059669]/90">
                <h1 className="text-5xl text-[#fff] text-center font-outfit">We Make Hiring Simple </h1>
                <p className="text-center text-lg text-white font-rubik w-2/3 mx-auto mt-2">Finding skilled, reliable talent shouldn't feel impossible.
                    With Hiregy, you can build your team in three easy steps;</p>
                <div className="flex gap-x-10">
                    {serviceItem.map((item, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="flex-1 min-w-0  text-white flex flex-col justify-center items-center gap-y-2 my-10 bg-transparent"
                            >
            ...
            <div className="p-16 flex gap-x-20">
                <div className="w-1/2 ">
                    <h1 className="text-5xl font-redRose ">Staffing every role in your call center</h1>
                    ...
                    <div className="flex items-center gap-x-1 mt-4 font-semibold">
                ...
                <div className="grid grid-cols-2 gap-x-4 w-4/5">
                    ...
                    <div className="flex flex-col top-10 gap-y-4 relative ">
                        <Card className="p-3 flex gap-x-2 flex-row items-start ">
                            <HeadsetIcon className="text-[#059669] w-14 h-14" />
                            <div>
                                <h2 className="font-outfit text-lg w-fit mb-2 leading-relaxed font-semibold text-[#059669]">Customer Service Representatives</h2>
            ...
            <div className="bg-gradient-to-r from-[#34D399] via-[#065f46] to-[#34D399] p-16 text-white">
                <h1 className="font-redRose text-5xl text-center">We Understand the pressure of building a winning call center team </h1>
                <p className="w-2/3 mx-auto text-center text-xl font-outfit mt-3">
                ...
                <div className="grid grid-cols-3 w-2/3 mx-auto text-center my-8 gap-x-8">
